...
#%%
data_C11 = np.loadtxt(r"C:\Users\SadTime\Desktop\update1\Canola\calibrationC11.csv", delimiter=",")
data_C22 = np.loadtxt(r"C:\Users\SadTime\Desktop\update1\Canola\calibrationC22.csv", delimiter=",")
data_C33 = np.loadtxt(r"C:\Users\SadTime\Desktop\update1\Canola\calibrationC33.csv", delimiter=",")
...
data_label = np.loadtxt(r"C:\Users\SadTime\Desktop\update1\Canola\calibrationcrop.csv", delimiter=",")

target_label = data_label[:,0:2]

data_label_input_test = np.loadtxt(r"C:\Users\SadTime\Desktop\update1\Canola\validation_cropsigma.csv", delimiter=",")
data_label_target_test = np.loadtxt(r"C:\Users\SadTime\Desktop\update1\Canola\validation_cropparam.csv", delimiter=",")
...
#    L1 = tf.norm(tf.math.subtract(y1,logits1),ord=2)
...
#    L2 = tf.norm(tf.math.subtract(SAR_in,SAR_out),ord=2)
    # print(L1,L2)
    return (L1+L3, L2)
#%%
...
print('                     -------')
print("Test correlation: {:.2f}".format(test_corr))
...
#regr_multirf = MultiOutputRegressor(SVR(kernel='sigmoid'))
